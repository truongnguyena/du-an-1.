...
private void search() {
    ...
    private PhieuPhat getForm() {
        ...
        int maPhieuPhat = Integer.parseInt(txtMaPhieuPhat.getText());
    ...
    private void addViolation() {
        ...
        vpdao = new ViPhamDAO();
        try {
            if (XValidate.checkNullText(txtMaDocGia)
                    && XValidate.checkNullText(txtPhiPhat)
                    && txtaNoiDungPhat.getText().isEmpty()) {
                XDialog.alert(this, "Vui lòng điền dầy đủ thông tin");
            } else {
                vpdao.insert(p);
